...
export const STARTER_TEMPLATES: StarterTemplate[] = [
  {
    id: "balanced-life",
    name: "Balanced Life",
    description: "Health, family, work, home, and personal growth — the classic life-balance starting point.",
    pillars: [
      {
        name: "Health",
        color: "#10b981",
  ...
  },
  {
    id: "solo-founder",
    name: "Solo Founder",
    description: "Product, customers, marketing, plus the personal foundations you can't ignore.",
    pillars: [
      {
        name: "Product",
        color: "#3b82f6",
  ...
  },
  {
    id: "student",
    name: "Student",
    description: "Academics first, but career prep, health, and relationships still get a seat at the table.",
    pillars: [
      {
        name: "Academics",
        color: "#3b82f6",
  ...
  },
  {
    ...
    description: "For artists, writers, and makers — protect the craft, build the audience, keep the lights on.",
    pillars: [
      {
        name: "Craft",
        color: "#ec4899",
