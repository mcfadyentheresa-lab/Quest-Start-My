...
export default function Dashboard() {
  ...
  const [focusPopoverOpen, setFocusPopoverOpen] = useState<boolean>(false);
        ...
        {!isViewingHistory && !timer.isRunning && !timer.isNudging && pendingTasksToday.length > 0 && (
          <div className="mb-3 flex justify-end">
            <Popover open={focusPopoverOpen} onOpenChange={setFocusPopoverOpen}>
              ...
              <PopoverContent align="end" className="w-auto max-w-[min(92vw,28rem)] p-3">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="text-xs text-muted-foreground truncate">on: {focusedTask?.title ?? "first task"}</span>
                </div>
                <div className="flex items-center gap-1.5 flex-wrap">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      if (focusedTask) {
                        handleStartFocusBlock(focusedTask);
